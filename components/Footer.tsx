  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div className="col-span-1 md:col-span-1">
        <h3 className="text-white text-2xl font-bold mb-4">Nexus AI Labs</h3>
        <p className="text-sm text-gray-400">
          Pioneering the future of artificial intelligence through innovative research and development.
        </p>
      </div>

      {/* Products */}
      <div>
        <h4 className="text-white text-sm font-semibold uppercase tracking-wider mb-4">Products</h4>
        <ul className="space-y-2">
          <li><a href="#" className="text-sm hover:text-white transition-colors">AI Platform</a></li>
          <li><a href="#" className="text-sm hover:text-white transition-colors">Machine Learning</a></li>
          <li><a href="#" className="text-sm hover:text-white transition-colors">Neural Networks</a></li>
          <li><a href="#" className="text-sm hover:text-white transition-colors">API Solutions</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2">
          ...
          <li><a href="#" className="text-sm hover:text-white transition-colors">Research</a></li>
