  ...
  <div className="max-w-7xl mx-auto">
    <div className="text-center mb-16">
      ...
      <p className="text-xl text-gray-600 max-w-2xl mx-auto">
        Flexible pricing plans designed to scale with your AI ambitions
      </p>
    </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-gray-200 hover:border-blue-500 transition-all duration-300">
        ...
        <ul className="space-y-4 mb-8">
          ...
          <li className="flex items-start">
            ...
            <span className="text-gray-700">Basic AI models access</span>
          </li>
          <li className="flex items-start">
            <svg className="w-6 h-6 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 border-2 border-blue-500 relative transform md:scale-105 hover:scale-110 transition-all duration-300">
        ...
        <ul className="space-y-4 mb-8">
          ...
          <li className="flex items-start">
            ...
            <span className="text-gray-700">Custom model fine-tuning</span>
          </li>
          <li className="flex items-start">
            <svg className="w-6 h-6 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-gray-200 hover:border-purple-500 transition-all duration-300">
        ...
        <ul className="space-y-4 mb-8">
          ...
          <li className="flex items-start">
            ...
            <span className="text-gray-700">All AI models + custom development</span>
          </li>
          <li className="flex items-start">
            <svg className="w-6 h-6 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
    ...
    <div className="mt-16 text-center">
      ...
      <p className="text-sm text-gray-500">Need a custom solution? <a href="#" className="text-blue-500 hover:text-blue-600 font-semibold">Contact our team</a></p>
    </div>
  </div>
</section>
  );
